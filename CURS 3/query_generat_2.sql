...
-- Schema facultate
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `facultate` DEFAULT CHARACTER SET utf8 ;
USE `facultate` ;

-- -----------------------------------------------------
-- Table `facultate`.`student`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `facultate`.`facultatea`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `facultate`.`facultatea` (
